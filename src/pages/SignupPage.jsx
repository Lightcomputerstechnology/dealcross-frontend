...
const SignupPage = () => {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      setTimeout(() => navigate('/login'), 2000);  // Or /dashboard
    } catch (err) {
      ...
      <main className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950 px-4">
        ...
        >
          ...
          <input
            ...
            className={`w-full px-4 py-2 rounded-lg bg-white dark:bg-gray-800 border ${
              confirm && password !== confirm ? 'border-red-500' : 'border-gray-300 dark:border-gray-700'
