...
import React from 'react'; import { Routes, Route } from 'react-router-dom'; import SiteLayout from '@/layouts/SiteLayout'; import useAuthRedirect from '@/hooks/useAuthRedirect';

// User context-aware routes const ProtectedUserRoute = ({ children }) => { useAuthRedirect(); return children; };

const ProtectedAdminRoute = ({ children }) => { useAuthRedirect({ adminOnly: true }); return children; };

// Imports (auto-generated list to cover all built pages) import LandingPage from '@/pages/LandingPage'; import LoginPage from '@/pages/LoginPage'; import SignupPage from '@/pages/SignupPage'; import AboutPage from '@/pages/AboutPage'; import ContactPage from '@/pages/ContactPage'; import FAQPage from '@/pages/FaqPage'; import PrivacyPolicyPage from '@/pages/PrivacyPolicyPage'; import TermsPage from '@/pages/TermsPage'; import RefundPolicyPage from '@/pages/RefundPolicyPage'; import DocsPage from '@/pages/DocsPage'; import WatermarkTest from '@/pages/WatermarkTest';

import DealsPage from '@/pages/DealsPage'; import DealDetailsPage from '@/pages/DealDetailsPage'; import StartDealPage from '@/pages/StartDealPage'; import StartDealPairing from '@/pages/StartDealPairing'; import DealConfirmation from '@/pages/DealConfirmation'; import DealTrackerPage from '@/pages/DealTrackerPage'; import WalletPage from '@/pages/WalletPage'; import FundWalletPage from '@/pages/FundWalletPage'; import TransactionHistory from '@/pages/TransactionHistory'; import WalletHistoryPage from '@/pages/WalletHistoryPage'; import KYCStatusPage from '@/pages/KYCStatusPage';

import ShareTrading from '@/pages/ShareTrading'; import ShareTradingTips from '@/pages/ShareTradingTips'; import TradingChartPage from '@/pages/TradingChartPage'; import LiveTradingChart from '@/pages/LiveTradingChart';

import UserProfile from '@/pages/UserProfile'; import UserProfileEditPage from '@/pages/UserProfileEditPage'; import UserSettingsPage from '@/pages/UserSettingsPage'; import UpgradePage from '@/pages/UpgradePage'; import SettingsPage from '@/pages/Settings'; import KYCUploadPage from '@/pages/KYCUploadPage'; import DisputeResolutionPage from '@/pages/DisputeResolutionPage'; import ReferralProgram from '@/pages/ReferralProgram'; import SecurityCenter from '@/pages/SecurityCenter';

import BlogListPage from '@/pages/BlogListPage'; import WhyDealcrossBeats from '@/pages/WhyDealcrossBeats'; import DisputeResolutionGuide from '@/pages/DisputeResolutionGuide'; import FastPayoutsExplained from '@/pages/FastPayoutsExplained'; import IntroToDealcross from '@/pages/IntroToDealcross';

import AdminDashboard from '@/pages/AdminDashboard'; import AdminAnalyticsPage from '@/pages/AdminAnalyticsPage'; import DealAnalytics from '@/pages/DealAnalytics'; import ReportCenter from '@/pages/ReportCenter'; import EscrowDashboard from '@/pages/EscrowDashboard'; import FraudDetectionLog from '@/pages/FraudDetectionLog'; import UserManagement from '@/pages/UserManagement'; import DisputeLogViewer from '@/pages/DisputeLogViewer'; import PitchDeckViewer from '@/pages/PitchDeckViewer'; import EscrowTracker from '@/pages/EscrowTracker'; import MobileAppPromo from '@/pages/MobileAppPromo'; import ChatSupport from '@/pages/ChatSupport'; import AIInsightCenter from '@/pages/AIInsightCenter'; import AdminDealLog from '@/pages/AdminDealLog'; import AdminCharts from '@/pages/AdminCharts'; import AuditLogViewer from '@/pages/AuditLogViewer'; import PendingDealList from '@/components/admin/PendingDealList'; import UserControlList from '@/components/admin/UserControlList'; import AdminUserEditPage from '@/pages/AdminUserEditPage'; import FraudAlertsPage from '@/pages/FraudAlertsPage'; import AdminNotifications from '@/pages/AdminNotificationsPage'; import AdminRoleManagement from '@/pages/AdminRoleManagementPage'; import AdminSettingsCenter from '@/pages/AdminSettingsPage'; import FinancialReports from '@/pages/FinancialReportsPage'; import AdminKYCReviews from '@/pages/AdminKYCReviewsPage'; import RealTimeMetrics from '@/pages/RealTimeMetricsPage'; import ReferralLogs from '@/pages/ReferralLogsPage'; import AdminSearch from '@/pages/AdminSearchPage'; import FraudAnalysis from '@/pages/FraudAnalysisPage'; import DataExportPage from '@/pages/DataExportPage'; import ServerHealth from '@/pages/ServerHealthPage'; import APIUsageStats from '@/pages/APIUsageStatsPage'; import SystemLogsViewer from '@/pages/SystemLogsViewerPage'; import ExchangeRatesViewer from '@/pages/ExchangeRatesViewerPage'; import SubscriptionPlansManager from '@/pages/SubscriptionPlansManagerPage';

import NotFound from '@/pages/NotFound';

export default function AppRoutes() { return ( <Routes> <Route element={<SiteLayout />}> {/* Public */} <Route path="/" element={<LandingPage />} /> <Route path="login" element={<LoginPage />} /> <Route path="signup" element={<SignupPage />} /> <Route path="about" element={<AboutPage />} /> <Route path="contact" element={<ContactPage />} /> <Route path="faq" element={<FAQPage />} /> <Route path="privacy" element={<PrivacyPolicyPage />} /> <Route path="terms" element={<TermsPage />} /> <Route path="refund" element={<RefundPolicyPage />} /> <Route path="docs" element={<DocsPage />} /> <Route path="watermark" element={<WatermarkTest />} />
