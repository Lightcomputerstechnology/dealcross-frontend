...
import { Menu as MenuIcon, X as XIcon, Bell } from 'react-feather';
          ...
          {user ? (
            <div className="relative group">
              ...
              <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded shadow-lg hidden group-hover:block z-50">
                <Link to="/notifications" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700">Notifications ({notifications?.length || 0})</Link>
                <Link to="/dashboard" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700">Dashboard</Link>
                <button onClick={logout} className="w-full text-left px-4 py-2 hover:bg-red-100 dark:hover:bg-red-600 text-red-600 dark:text-white">Logout</button>
              </div>
            </div>
          ) : (
            <>
              ...
              <div className="border-t pt-4 space-y-4">
                {user ? (
                  <>
                    ...
                    <Link to="/notifications" className="block hover:text-blue-600 dark:hover:text-blue-400">Notifications ({notifications?.length})</Link>
                    <Link to="/dashboard" className="block hover:text-blue-600 dark:hover:text-blue-400">Dashboard</Link>
