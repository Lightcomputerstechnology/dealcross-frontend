    ...
    <nav className={`bg-white dark:bg-gray-950 relative z-50 transition-shadow duration-300 ${scrolled ? "shadow-lg" : ""}`}>
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-3">
          <Link to="/login" className="px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-full transition">Login</Link>
          <Link to="/signup" className="px-3 py-1.5 bg-gray-800 hover:bg-gray-700 text-white text-sm font-semibold rounded-full transition">Sign Up</Link>
          <ThemeToggle />
          <LanguageSwitcher />
        </div>
        ...
        <div className="flex items-center md:hidden space-x-2">
          <Link to="/login" className="px-3 py-1 text-xs bg-blue-600 text-white rounded-full font-semibold hover:bg-blue-700">Login</Link>
          <Link to="/signup" className="px-3 py-1 text-xs bg-gray-800 text-white rounded-full font-semibold hover:bg-gray-700">Sign Up</Link>
        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 w-3/4 h-full bg-white dark:bg-gray-950 p-6 z-50 shadow-lg space-y-6 text-lg font-medium transition-colors"
            >
