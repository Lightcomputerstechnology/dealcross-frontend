...
n          open ? 'opacity-100' : 'opacity-0 pointer-events-none'
        }`}
      ...
      {/* Mobile Sidebar */}
      <div
        className={`fixed top-0 right-0 w-3/4 h-full bg-white dark:bg-gray-950 text-gray-900 dark:text-white z-50 p-6 transform transition-transform duration-300 ${
n          open ? 'translate-x-0' : 'translate-x-full'
        }`}
      >
